            ...
            >
                <div className="p-4 flex justify-between items-center">
                    ...
                    <button onClick={closeSidebar}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 24 24"><path fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M18 6L6 18M6 6l12 12" /></svg>
                    </button>
                </div>
