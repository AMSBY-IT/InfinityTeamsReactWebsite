...
const CandidateCard = () => {
    ...
    return (
        <div className="" role="tabpanel" id="grid">
            <div className="grid max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 max-xl:grid-cols-2 xl:grid-cols-3 gap-3" id="candidateContainer">
                    ...
                    <div className="flex" key={candidate.id}>
                        <div className="flex flex-col rts__job__card p-4 border-[1px] bg-white border-[#dcdddf] rounded-md cursor-pointer hover:bg-hover-gradient">
                            <div className="flex gap-4">
                                <div className="flex">
                                    <img src={`https://ui-avatars.com/api/?name=${candidate.firstName}+${candidate.lastName}`} alt="" className="w-[60px] h-[60px] rounded-sm" />
                                </div>
                                <div className="flex flex-col">
                                    <h2 className="leading-5 text-[18px] text-untitled-ui--gray900 m-0 font-medium">{candidate.firstName}</h2>
                                    <span className="text-[11px] font-medium text-untitled-ui--gray800">{candidate.currentJobTitle}</span>
                            ...
                            <div className="flex items-center justify-between mt-6">
                                <p className="text-[14px] text-untitled-ui--gray800 m-0 font-medium">Student Entry</p>
                                <p className="text-[14px] text-untitled-ui--gray800 m-0 font-medium">Remote Job</p>
                                <p className="text-[14px] text-untitled-ui--gray800 m-0 font-medium">$ 10520 PA</p>
                            </div>
                            <p className="candi-desc mt-4 text-sm text-black line-clamp-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi blanditiis iure in provident,
