        ...
        <div className='mx-auto max-sm:w-11/12 max-lg:w-11/12'>
          <div className='flex justify-between bg-white rounded-md border-[1px] max-lg:flex-col'>
            <div className="flex items-center p-3 justify-between gap-4 px-4 grow max-lg:flex-col max-lg:py-4">
              ...
              <div className="flex items-center gap-2 grow max-lg:w-full">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className='w-5' viewBox="0 0 22 22"><g fill="none" stroke="#7f56d9" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm5-2V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m-4 5v.01" /><path d="M3 13a20 20 0 0 0 18 0" /></g></svg>
                </div>
                <Select
                  options={skill}
