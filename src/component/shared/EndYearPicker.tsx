    ...
    return (
        <div className="pt-3">
            ...
            <Popover>
                        ...
                        >
                            <div className="flex space-x-2 items-center py-2">
                                ...
                                <div>
                                    ...
                                    {endYear ? endYear.getFullYear() : <span>Pick a date</span>}
                                </div>
                            </div>
                        </Button>
                    </div>
                ...
                <PopoverContent>
                    <Calendar onChange={handleDateSelect} value={endYear} view="decade" maxDetail="decade"/>
                </PopoverContent>
            </Popover>
        </div>
    )
